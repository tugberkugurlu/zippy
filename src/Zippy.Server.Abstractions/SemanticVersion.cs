...
namespace Zippy.Server.Abstractions 
{
    ...
    /// </summary>
    /// <remarks>
    /// Taken as is from http://nuget.codeplex.com/SourceControl/latest#src/Core/SemanticVersion.cs
    /// </remarks>
#if DNX451
    [Serializable]
#endif
    ...
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        public static SemanticVersion Parse(string version)
        {
            ...
            {
                throw new ArgumentException("TODO: Version cannot be null or empty.", "version");
            }

            SemanticVersion semVer;
            if (!TryParse(version, out semVer))
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, "TODO: Version is invalid.", version), "version");
            }
            return semVer;
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (other == null)
            {
                throw new ArgumentException("Type must be of type SemanticVersion", "obj");
            }
    ...
    /// <remarks>
    /// Taken as is from http://nuget.codeplex.com/SourceControl/latest#src/Core/SemanticVersionTypeConverter.cs
    /// </remarks>
